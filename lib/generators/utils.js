...
export function getTemplatePath (type, options = {}) {
  ...
  if (options.testTemplate) {
    if (type === 'component') {
      relativePath =
        '../../templates/client/modules/core/components/tests/test.tt'
    } else if (type === 'container') {
      relativePath =
        '../../templates/client/modules/core/containers/tests/test.tt'
    } else if (type === 'action') {
...
export function removeFromIndexFile (indexFilePath, entityName, options = {}) {
  ...
  let varName = options.capitalizeVarName
    ? _.capitalize(_.camelCase(entityName))
...
export function _generate (type, moduleName, entityName, options, customConfig) {
  ...
  let templateVariables = getTemplateVaraibles(
    type,
    moduleName,
    entityName,
    options
