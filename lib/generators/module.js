...
export function generateModule (name, options, customConfig = {}) {
  ...
  createFile(
    `${templatesPath}/client/modules/core/actions/index.js`,
    `${modulePath}/actions/index.js`
  )
  createFile(
    `${templatesPath}/client/modules/core/index.js`,
    `${modulePath}/index.js`
  )
  createFile(
    `${templatesPath}/client/modules/core/routes.tt`,
    `${modulePath}/routes.jsx`
  )
  if (name === 'core') {
    createFile(
      `${templatesPath}/client/modules/core/components/main_layout.jsx`,
      `${modulePath}/components/main_layout.jsx`
    )
    createFile(
      `${templatesPath}/client/modules/core/components/home.jsx`,
  ...
  insertToFile(clientMain, `app.loadModule(${snakeCaseName}Module);`, {
    or: [
      {
        after: {
  ...
  if (config.storybook) {
    ...
    createFile(
      `${templatesPath}/client/modules/core/components/.stories/index.js`,
      moduleStoriesIndex
    )
  }
}
